...
/**
 * This test checks the properties of the default UI attributes for a {@link Label} widget - those with attribute = "".
 * 
 * @author Tonny Madsen, The RCP Company
 */
public class UIAttributeLabelFactoryPropertiesTest extends BaseUIAttributeFactoryTest<Label> {
