...
/**
 * This test checks the properties of the default UI attributes for a {@link Button} widget - those with attribute = "".
 * 
 * @author Tonny Madsen, The RCP Company
 */
public class UIAttributePushButtonFactoryPropertiesTest extends BaseUIAttributeFactoryTest<Button> {
	protected IUIAttribute attribute = null;

	@Test
	public void testUIAttribute() {
		final Button widget = createWidget(Button.class, SWT.PUSH);
