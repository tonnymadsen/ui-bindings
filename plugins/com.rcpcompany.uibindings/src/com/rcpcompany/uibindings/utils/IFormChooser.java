...
public interface IFormChooser extends IDisposable {
	public final static class Factory {
		...
		public static IFormChooser create(IBindingContext context, EObject object, EStructuralFeature feature,
				Composite top) {
			return create(context, UIBindingsEMFObservables.observeValue(null, context.getEditingDomain(), object,
					feature), top);
		}
		...
		public static IFormChooser create(IBindingContext context, IObservableValue value, EStructuralFeature feature,
				Composite top) {
			return create(context, UIBindingsEMFObservables.observeDetailValue(context.getEditingDomain(), value,
					feature), top);
		}
	}

	/**
	 * Interface used by the general {@link IFormChooser#addForm(IFormChooserTester, IFormChooserCreator)}.
	 */
