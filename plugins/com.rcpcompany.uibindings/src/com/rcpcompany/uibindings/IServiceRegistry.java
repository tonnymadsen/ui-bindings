...
/**
 * <!-- begin-user-doc --> The service registry is a basic registry that allows various services to be registered with a
 * base object - currently one of {@link IBindingContext}, {@link IViewerBinding}, {@link IColumnBinding} and
 * {@link IValueBinding}. <!-- end-user-doc -->
 * 
 * <p>
...
public interface IServiceRegistry extends EObject {
	/**
	 * Returns the service with the specified interface if it has been registered with the base object.
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Services</b></em>' attribute list. The list contents are of type
	 * {@link java.lang.Object}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Services</em>' attribute list isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
