...
public interface IValidationAdapterManagerChangeListener {
	/**
	 * Signals that the state of the {@link IValidatorAdapterManager} has changed. specified objects have either gotten
	 * additional messages, changed messages or "lost" messages.
	 * 
