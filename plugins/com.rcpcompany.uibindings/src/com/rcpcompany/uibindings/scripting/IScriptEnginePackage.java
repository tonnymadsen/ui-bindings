...
public interface IScriptEnginePackage extends EPackage {
	...
	/**
	 * The meta object id for the '
	 * {@link com.rcpcompany.uibindings.internal.scripting.EObjectToScriptDependencyListMapEntryImpl
	 * <em>EObject To Script Dependency List Map Entry</em>}' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The feature id for the '<em><b>Value</b></em>' reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.scripting.IScriptDependency#getIndex <em>Index</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.scripting.IScriptDependency#getKey <em>Key</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for class '{@link java.util.Map.Entry
	 * <em>EObject To Script Dependency List Map Entry</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference EOBJECT_TO_SCRIPT_DEPENDENCY_LIST_MAP_ENTRY__KEY = eINSTANCE
				.getEObjectToScriptDependencyListMapEntry_Key();
		 ...
		 * @generated
		 */
		EReference EOBJECT_TO_SCRIPT_DEPENDENCY_LIST_MAP_ENTRY__VALUE = eINSTANCE
				.getEObjectToScriptDependencyListMapEntry_Value();
