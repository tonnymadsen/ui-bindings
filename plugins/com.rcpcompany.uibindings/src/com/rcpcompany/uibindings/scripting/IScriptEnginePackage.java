...
public interface IScriptEnginePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SCRIPT_DEPENDENCY__INDEX = 3;
	 ...
	 * @ordered
	 */
	int SCRIPT_DEPENDENCY_FEATURE_COUNT = 5;
	...
	/**
	 * The meta object id for the '{@link com.rcpcompany.uibindings.internal.scripting.EObjectToScriptDependencyListMapEntryImpl <em>EObject To Script Dependency List Map Entry</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see com.rcpcompany.uibindings.internal.scripting.EObjectToScriptDependencyListMapEntryImpl
	 * @see com.rcpcompany.uibindings.internal.scripting.ScriptEnginePackageImpl#getEObjectToScriptDependencyListMapEntry()
	 * @generated
	 */
	int EOBJECT_TO_SCRIPT_DEPENDENCY_LIST_MAP_ENTRY = 7;
	 ...
	 * @ordered
	 */
	int EOBJECT_TO_SCRIPT_DEPENDENCY_LIST_MAP_ENTRY__KEY = 0;
	 ...
	 * @ordered
	 */
	int EOBJECT_TO_SCRIPT_DEPENDENCY_LIST_MAP_ENTRY__VALUE = 1;

	/**
	 * The number of structural features of the '<em>EObject To Script Dependency List Map Entry</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int EOBJECT_TO_SCRIPT_DEPENDENCY_LIST_MAP_ENTRY_FEATURE_COUNT = 2;
	 ...
	 * @generated
	 */
	int EOBJECT_TO_SCRIPT_ENGINE_MAP_ENTRY = 8;
	...
	/**
	 * Returns the meta object for the map '{@link com.rcpcompany.uibindings.scripting.IScriptManager#getDependencies <em>Dependencies</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link com.rcpcompany.uibindings.scripting.IScriptDependency#getIndex <em>Index</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Index</em>'.
	 * @see com.rcpcompany.uibindings.scripting.IScriptDependency#getIndex()
	 * @see #getScriptDependency()
	 * @generated
	 */
	EAttribute getScriptDependency_Index();

	/**
	 * Returns the meta object for the attribute '{@link com.rcpcompany.uibindings.scripting.IScriptDependency#getKey <em>Key</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Key</em>'.
	 * @see com.rcpcompany.uibindings.scripting.IScriptDependency#getKey()
	 * @see #getScriptDependency()
	 * @generated
	 */
	EAttribute getScriptDependency_Key();
	...
	/**
	 * Returns the meta object for class '{@link java.util.Map.Entry <em>EObject To Script Dependency List Map Entry</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>EObject To Script Dependency List Map Entry</em>'.
	 * @see java.util.Map.Entry
	 * @generated
	 */
	EClass getEObjectToScriptDependencyListMapEntry();
	 ...
	 * @see java.util.Map.Entry
	 * @see #getEObjectToScriptDependencyListMapEntry()
	 * @generated
	 */
	EReference getEObjectToScriptDependencyListMapEntry_Key();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute SCRIPT_DEPENDENCY__INDEX = eINSTANCE.getScriptDependency_Index();
		 ...
		 * @generated
		 */
		EAttribute SCRIPT_DEPENDENCY__KEY = eINSTANCE.getScriptDependency_Key();
		...
		/**
		 * The meta object literal for the '{@link com.rcpcompany.uibindings.internal.scripting.EObjectToScriptDependencyListMapEntryImpl <em>EObject To Script Dependency List Map Entry</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see com.rcpcompany.uibindings.internal.scripting.EObjectToScriptDependencyListMapEntryImpl
		 * @see com.rcpcompany.uibindings.internal.scripting.ScriptEnginePackageImpl#getEObjectToScriptDependencyListMapEntry()
		 * @generated
		 */
		EClass EOBJECT_TO_SCRIPT_DEPENDENCY_LIST_MAP_ENTRY = eINSTANCE.getEObjectToScriptDependencyListMapEntry();
		 ...
		 * @generated
		 */
		EReference EOBJECT_TO_SCRIPT_DEPENDENCY_LIST_MAP_ENTRY__KEY = eINSTANCE.getEObjectToScriptDependencyListMapEntry_Key();
		 ...
		 * @generated
		 */
		EReference EOBJECT_TO_SCRIPT_DEPENDENCY_LIST_MAP_ENTRY__VALUE = eINSTANCE.getEObjectToScriptDependencyListMapEntry_Value();
