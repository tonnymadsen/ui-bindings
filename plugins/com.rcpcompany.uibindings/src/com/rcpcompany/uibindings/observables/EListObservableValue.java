 ...
 */
public class EListObservableValue extends AbstractObservableValue implements IKeyedObservable, IObserving {
	protected final IObservableValue myObjectOV;
	protected final EStructuralFeature mySF;
	protected final int myIndex;
	private final EditingDomain myEditingDomain;

	protected EObject myObject = null;
	 ...
	 */
	public EListObservableValue(IObservableValue ov, EStructuralFeature sf, int index) {
	 ...
	 * @param index the element of the list
	 */
	public EListObservableValue(EditingDomain editingDomain, IObservableValue ov, EStructuralFeature sf, int index) {
