...
/**
 * This interface is used to adapt between the {@link ContextMessageDecorator} and the form/wizard/whatever that is used
 * to shows the context.
 * <p>
 * The main function of the interface is {@link #update(List,boolean,int)} that should update the form/whatever with
 * <ul>
 * <li>a specified list of messages are to be shown</li>
 * <li>whether the context is in error or not. This is used to enable/disable any build-in "Accept", "OK", or "Next"
 * buttons.</li>
 * </ul>
 * 
...
public interface IContextMessageDecoratorAdapter extends IDisposable {
	 ...
	 * @param maxType the max message type - one of {@link IMessageProvider#NONE}, {@link IMessageProvider#INFORMATION},
