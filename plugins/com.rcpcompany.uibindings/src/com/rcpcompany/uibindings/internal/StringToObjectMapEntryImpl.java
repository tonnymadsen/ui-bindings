...
public class StringToObjectMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<String, Object> {
	...
	protected EClass eStaticClass() {
		return IUIBindingsPackage.Literals.STRING_TO_OBJECT_MAP_ENTRY;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, IUIBindingsPackage.STRING_TO_OBJECT_MAP_ENTRY__KEY,
					oldKey, key));
		}
	}
	...
	public void setTypedValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, IUIBindingsPackage.STRING_TO_OBJECT_MAP_ENTRY__VALUE,
					oldValue, value));
		}
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IUIBindingsPackage.STRING_TO_OBJECT_MAP_ENTRY__KEY:
			return getTypedKey();
		case IUIBindingsPackage.STRING_TO_OBJECT_MAP_ENTRY__VALUE:
