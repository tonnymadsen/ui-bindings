 ...
 */
public class MyStyledTextCellEditor extends StyledTextCellEditor {
	/**
	 * The column of the cell editor
	 */
	...
	protected MyStyledTextCellEditor(Composite parent, IBindingContext context) {
		super(parent, SWT.LEAD);
		myContext = context;
		undoHandler = new AbstractHandler() {
			...
			public Object execute(ExecutionEvent event) {
				...
				if (Activator.getDefault().TRACE_LIFECYCLE_COLUMN_EDITORS) {
					LogUtils.debug(myContext, "cancelled");
				}
				fireCancelEditor();
				return null;
			}
