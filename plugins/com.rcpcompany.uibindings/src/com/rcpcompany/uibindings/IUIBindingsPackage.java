...
public interface IUIBindingsPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Argument Information</b></em>' map. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int MANAGER__ARGUMENT_INFORMATION = BASE_OBJECT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int MANAGER__PROVIDERS = BASE_OBJECT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int MANAGER__UI_ATTRIBUTE_FACTORIES = BASE_OBJECT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int MANAGER__DECORATOR_EXTENDERS = BASE_OBJECT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int MANAGER__MODEL_ARGUMENT_MEDIATORS = BASE_OBJECT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int MANAGER__MODEL_ARGUMENT_MEDIATOR_CLASSES = BASE_OBJECT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int MANAGER__TEXT_COMMIT_STRATEGY = BASE_OBJECT_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int MANAGER__TEXT_COMMIT_STRATEGY_DELAY = BASE_OBJECT_FEATURE_COUNT + 9;
	 ...
	 * @ordered
	 */
	int MANAGER__EDIT_CELL_ANY_KEY = BASE_OBJECT_FEATURE_COUNT + 10;
	 ...
	 * @ordered
	 */
	int MANAGER__EDIT_CELL_SINGLE_CLICK = BASE_OBJECT_FEATURE_COUNT + 11;
	 ...
	 * @ordered
	 */
	int MANAGER__MESSAGE_DECORATION_POSITION = BASE_OBJECT_FEATURE_COUNT + 12;
	 ...
	 * @ordered
	 */
	int MANAGER__MESSAGE_DECORATION_MINIMUM_SEVERITY = BASE_OBJECT_FEATURE_COUNT + 13;
	 ...
	 * @ordered
	 */
	int MANAGER__ALTERNATIVE_DECORATION_POSITION = BASE_OBJECT_FEATURE_COUNT + 14;
	 ...
	 * @ordered
	 */
	int MANAGER__AUTO_APPLY_SINGLE_QUICKFIX = BASE_OBJECT_FEATURE_COUNT + 15;
	 ...
	 * @ordered
	 */
	int MANAGER__ALTERNATE_ROW_COLORS = BASE_OBJECT_FEATURE_COUNT + 16;
	 ...
	 * @ordered
	 */
	int MANAGER__VALIDATION_ERRORS_ARE_FATAL = BASE_OBJECT_FEATURE_COUNT + 17;
	 ...
	 * @ordered
	 */
	int MANAGER__VALIDATION_DELAY = BASE_OBJECT_FEATURE_COUNT + 18;
	 ...
	 * @ordered
	 */
	int MANAGER__VALIDATION_DELAY_WINDOW = BASE_OBJECT_FEATURE_COUNT + 19;
	 ...
	 * @ordered
	 */
	int MANAGER__REQUIRED_VB_IMAGE_DECORATION_SHOWN = BASE_OBJECT_FEATURE_COUNT + 20;
	 ...
	 * @ordered
	 */
	int MANAGER__ASSIST_VB_IMAGE_DECORATION_SHOWN = BASE_OBJECT_FEATURE_COUNT + 21;
	 ...
	 * @ordered
	 */
	int MANAGER__QUICKFIX_VB_IMAGE_DECORATION_SHOWN = BASE_OBJECT_FEATURE_COUNT + 22;
	 ...
	 * @ordered
	 */
	int MANAGER__VIEW_NAVIGATION_RECORDED = BASE_OBJECT_FEATURE_COUNT + 23;
	 ...
	 * @ordered
	 */
	int MANAGER__MODEL_INFO = BASE_OBJECT_FEATURE_COUNT + 24;
	 ...
	 * @ordered
	 */
	int MANAGER__TREE_ITEMS = BASE_OBJECT_FEATURE_COUNT + 25;
	 ...
	 * @ordered
	 */
	int MANAGER__CLIPBOARD = BASE_OBJECT_FEATURE_COUNT + 26;
	 ...
	 * @ordered
	 */
	int MANAGER__OBSERVABLE_FACTORIES = BASE_OBJECT_FEATURE_COUNT + 27;
	...
	/**
	 * The feature id for the '<em><b>Model Kind</b></em>' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int VALUE_BINDING__MODEL_KIND = BINDING_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING__MODEL_OBSERVABLE_VALUE = BINDING_FEATURE_COUNT + 2;

	/**
	 * The feature id for the '<em><b>Model Observable List</b></em>' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int VALUE_BINDING__MODEL_OBSERVABLE_LIST = BINDING_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING__MODEL_OBJECT = BINDING_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING__MODEL_FEATURE = BINDING_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING__DECORATOR_PROVIDER = BINDING_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING__DECORATOR = BINDING_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING__UI_ATTRIBUTE = BINDING_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING__UI_OBSERVABLE = BINDING_FEATURE_COUNT + 9;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING__CELL = BINDING_FEATURE_COUNT + 10;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING__MESSAGE_PREFIX = BINDING_FEATURE_COUNT + 11;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING__DYNAMIC = BINDING_FEATURE_COUNT + 12;
	 ...
	 * @ordered
	 */
	int VALUE_BINDING_FEATURE_COUNT = BINDING_FEATURE_COUNT + 13;
	 ...
	 * @generated
	 */
	int JAVA_DECORATOR_PROVIDER = 12;
	 ...
	 * @generated
	 */
	int ENUM_DECORATOR_PROVIDER = 13;
	 ...
	 * @generated
	 */
	int NUMBER_DECORATOR_PROVIDER = 15;
	...
	/**
	 * The meta object id for the '
	 * {@link com.rcpcompany.uibindings.internal.ArgumentInformationImpl
	 * <em>Argument Information</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see com.rcpcompany.uibindings.internal.ArgumentInformationImpl
	 * @see com.rcpcompany.uibindings.internal.UIBindingsPackageImpl#getArgumentInformation()
	 * @generated
	 */
	int ARGUMENT_INFORMATION = 10;
	 ...
	 * @ordered
	 */
	int ARGUMENT_INFORMATION__NAME = 0;

	/**
	 * The feature id for the '<em><b>Lookup Parent</b></em>' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ARGUMENT_INFORMATION__LOOKUP_PARENT = 1;

	/**
	 * The feature id for the '<em><b>Lookup Attribute Target Type</b></em>' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ARGUMENT_INFORMATION__LOOKUP_ATTRIBUTE_TARGET_TYPE = 2;

	/**
	 * The feature id for the '<em><b>Lookup Attribute Containing Class</b></em>' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ARGUMENT_INFORMATION__LOOKUP_ATTRIBUTE_CONTAINING_CLASS = 3;

	/**
	 * The feature id for the '<em><b>Lookup Reference Target Type</b></em>' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ARGUMENT_INFORMATION__LOOKUP_REFERENCE_TARGET_TYPE = 4;

	/**
	 * The feature id for the '<em><b>Lookup Reference Containing Class</b></em>' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ARGUMENT_INFORMATION__LOOKUP_REFERENCE_CONTAINING_CLASS = 5;

	/**
	 * The number of structural features of the '<em>Argument Information</em>' class. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ARGUMENT_INFORMATION_FEATURE_COUNT = 6;
	...
	/**
	 * The feature id for the '<em><b>Model Value Kind</b></em>' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int DECORATOR_PROVIDER__MODEL_VALUE_KIND = IARGUMENT_PROVIDER_FEATURE_COUNT + 9;
	 ...
	 * @ordered
	 */
	int DECORATOR_PROVIDER_FEATURE_COUNT = IARGUMENT_PROVIDER_FEATURE_COUNT + 10;
	 ...
	 * @ordered
	 */
	int JAVA_DECORATOR_PROVIDER__MODEL_VALUE_KIND = DECORATOR_PROVIDER__MODEL_VALUE_KIND;
	 ...
	 * @ordered
	 */
	int ENUM_DECORATOR_PROVIDER__MODEL_VALUE_KIND = DECORATOR_PROVIDER__MODEL_VALUE_KIND;
	 ...
	 * @generated
	 */
	int ENUM_DECORATOR_PROVIDER_ENTRY = 14;
	 ...
	 * @ordered
	 */
	int NUMBER_DECORATOR_PROVIDER__MODEL_VALUE_KIND = DECORATOR_PROVIDER__MODEL_VALUE_KIND;
	 ...
	 * @generated
	 */
	int UI_BINDING_DECORATOR_EXTENDER = 22;
	 ...
	 * @generated
	 */
	int UI_BINDING_DECORATOR_EXTENDER_DESCRIPTOR = 23;
	...
	/**
	 * The meta object id for the '
	 * {@link com.rcpcompany.uibindings.internal.AssignmentParticipantsManagerImpl
	 * <em>Assignment Participants Manager</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @see com.rcpcompany.uibindings.internal.AssignmentParticipantsManagerImpl
	 * @see com.rcpcompany.uibindings.internal.UIBindingsPackageImpl#getAssignmentParticipantsManager()
	 * @generated
	 */
	int ASSIGNMENT_PARTICIPANTS_MANAGER = 24;

	/**
	 * The feature id for the '<em><b>Participants</b></em>' reference list. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ASSIGNMENT_PARTICIPANTS_MANAGER__PARTICIPANTS = IDISPOSABLE_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>Assignment Participants Manager</em>' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ASSIGNMENT_PARTICIPANTS_MANAGER_FEATURE_COUNT = IDISPOSABLE_FEATURE_COUNT + 1;

	/**
	 * The meta object id for the '
	 * {@link com.rcpcompany.uibindings.internal.AssignmentParticipantDescriptorImpl
	 * <em>Assignment Participant Descriptor</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @see com.rcpcompany.uibindings.internal.AssignmentParticipantDescriptorImpl
	 * @see com.rcpcompany.uibindings.internal.UIBindingsPackageImpl#getAssignmentParticipantDescriptor()
	 * @generated
	 */
	int ASSIGNMENT_PARTICIPANT_DESCRIPTOR = 25;
	 ...
	 * @ordered
	 */
	int ASSIGNMENT_PARTICIPANT_DESCRIPTOR__MANAGER = 0;
	 ...
	 * @ordered
	 */
	int ASSIGNMENT_PARTICIPANT_DESCRIPTOR__ID = 1;

	/**
	 * The feature id for the '<em><b>Source Types</b></em>' attribute list. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ASSIGNMENT_PARTICIPANT_DESCRIPTOR__SOURCE_TYPES = 2;

	/**
	 * The feature id for the '<em><b>Destination Types</b></em>' attribute list. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ASSIGNMENT_PARTICIPANT_DESCRIPTOR__DESTINATION_TYPES = 3;

	/**
	 * The feature id for the '<em><b>Participant</b></em>' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int ASSIGNMENT_PARTICIPANT_DESCRIPTOR_FEATURE_COUNT = 6;
	 ...
	 * @generated
	 */
	int IMODEL_ARGUMENT_MEDIATOR = 28;
	 ...
	 * @generated
	 */
	int STRING_TO_MODEL_CLASS_INFO_MAP_ENTRY = 31;
	 ...
	 * @generated
	 */
	int STRING_TO_MODEL_FEATURE_INFO_MAP_ENTRY = 32;
	...
	/**
	 * The meta object id for the '
	 * {@link com.rcpcompany.uibindings.internal.StringToArgumentInformationMapEntryImpl
	 * <em>String To Argument Information Map Entry</em>}' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see com.rcpcompany.uibindings.internal.StringToArgumentInformationMapEntryImpl
	 * @see com.rcpcompany.uibindings.internal.UIBindingsPackageImpl#getStringToArgumentInformationMapEntry()
	 * @generated
	 */
	int STRING_TO_ARGUMENT_INFORMATION_MAP_ENTRY = 33;
	 ...
	 * @ordered
	 */
	int STRING_TO_ARGUMENT_INFORMATION_MAP_ENTRY__KEY = 0;
	 ...
	 * @ordered
	 */
	int STRING_TO_ARGUMENT_INFORMATION_MAP_ENTRY__VALUE = 1;

	/**
	 * The number of structural features of the '<em>String To Argument Information Map Entry</em>'
	 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int STRING_TO_ARGUMENT_INFORMATION_MAP_ENTRY_FEATURE_COUNT = 2;
	 ...
	 * @generated
	 */
	int STRING_TO_STRING_MAP_ENTRY = 34;
	 ...
	 * @generated
	 */
	int STRING_TO_OBJECT_MAP_ENTRY = 35;
	 ...
	 * @generated
	 */
	int STRING_TO_IMAGE_DESCRIPTOR_MAP_ENTRY = 36;
	 ...
	 * @generated
	 */
	int STRING_TO_ICONFIGURATION_ELEMENT_MAP_ENTRY = 37;
	 ...
	 * @generated
	 */
	int STRING_TO_BOOLEAN_MAP_ENTRY = 38;
	 ...
	 * @generated
	 */
	int QUICKFIX_PROPOSAL_PROCESSOR = 42;
	 ...
	 * @generated
	 */
	int QUICKFIX_PROPOSAL_PROCESSOR_CONTEXT = 43;
	 ...
	 * @generated
	 */
	int QUICKFIX_PROPOSAL_PROCESSOR_DESCRIPTOR = 44;
	 ...
	 * <em>Model Value Kind</em>}' enum. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Container Cell Type</em>}' enum. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see com.rcpcompany.uibindings.ContainerCellType
	 ...
	 * --> <!-- end-user-doc -->
	 * 
	 * @see com.rcpcompany.uibindings.participants.IAssignmentParticipant
	 ...
	 * {@link com.rcpcompany.uibindings.IManager#getAssignmentParticiantsManager
	 * <em>Assignment Particiants Manager</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the reference '<em>Assignment Particiants Manager</em>'.
	 * @see com.rcpcompany.uibindings.IManager#getAssignmentParticiantsManager()
	 * @see #getManager()
	 * @generated
	 */
	EReference getManager_AssignmentParticiantsManager();
	 ...
	 * {@link com.rcpcompany.uibindings.IManager#getArgumentInformation
	 * <em>Argument Information</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the map '<em>Argument Information</em>'.
	 * @see com.rcpcompany.uibindings.IManager#getArgumentInformation()
	 * @see #getManager()
	 * @generated
	 */
	EReference getManager_ArgumentInformation();
	...
	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.IValueBinding#getModelKind <em>Model Kind</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Model Kind</em>'.
	 * @see com.rcpcompany.uibindings.IValueBinding#getModelKind()
	 * @see #getValueBinding()
	 * @generated
	 */
	EAttribute getValueBinding_ModelKind();
	...
	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.IValueBinding#getModelObservableList
	 * <em>Model Observable List</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Model Observable List</em>'.
	 * @see com.rcpcompany.uibindings.IValueBinding#getModelObservableList()
	 * @see #getValueBinding()
	 * @generated
	 */
	EAttribute getValueBinding_ModelObservableList();
	...
	/**
	 * Returns the meta object for class '{@link com.rcpcompany.uibindings.IArgumentInformation
	 * <em>Argument Information</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for class '<em>Argument Information</em>'.
	 * @see com.rcpcompany.uibindings.IArgumentInformation
	 * @generated
	 */
	EClass getArgumentInformation();

	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.IArgumentInformation#getName <em>Name</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see com.rcpcompany.uibindings.IArgumentInformation#getName()
	 * @see #getArgumentInformation()
	 * @generated
	 */
	EAttribute getArgumentInformation_Name();

	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.IArgumentInformation#isLookupParent <em>Lookup Parent</em>}
	 * '. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Lookup Parent</em>'.
	 * @see com.rcpcompany.uibindings.IArgumentInformation#isLookupParent()
	 * @see #getArgumentInformation()
	 * @generated
	 */
	EAttribute getArgumentInformation_LookupParent();

	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.IArgumentInformation#isLookupAttributeTargetType
	 * <em>Lookup Attribute Target Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Lookup Attribute Target Type</em>'.
	 * @see com.rcpcompany.uibindings.IArgumentInformation#isLookupAttributeTargetType()
	 * @see #getArgumentInformation()
	 * @generated
	 */
	EAttribute getArgumentInformation_LookupAttributeTargetType();

	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.IArgumentInformation#isLookupAttributeContainingClass
	 * <em>Lookup Attribute Containing Class</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Lookup Attribute Containing Class</em>'.
	 * @see com.rcpcompany.uibindings.IArgumentInformation#isLookupAttributeContainingClass()
	 * @see #getArgumentInformation()
	 * @generated
	 */
	EAttribute getArgumentInformation_LookupAttributeContainingClass();

	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.IArgumentInformation#isLookupReferenceTargetType
	 * <em>Lookup Reference Target Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Lookup Reference Target Type</em>'.
	 * @see com.rcpcompany.uibindings.IArgumentInformation#isLookupReferenceTargetType()
	 * @see #getArgumentInformation()
	 * @generated
	 */
	EAttribute getArgumentInformation_LookupReferenceTargetType();

	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.IArgumentInformation#isLookupReferenceContainingClass
	 * <em>Lookup Reference Containing Class</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Lookup Reference Containing Class</em>'.
	 * @see com.rcpcompany.uibindings.IArgumentInformation#isLookupReferenceContainingClass()
	 * @see #getArgumentInformation()
	 * @generated
	 */
	EAttribute getArgumentInformation_LookupReferenceContainingClass();
	...
	/**
	 * Returns the meta object for the attribute '
	 * {@link com.rcpcompany.uibindings.IDecoratorProvider#getModelValueKind
	 * <em>Model Value Kind</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Model Value Kind</em>'.
	 * @see com.rcpcompany.uibindings.IDecoratorProvider#getModelValueKind()
	 * @see #getDecoratorProvider()
	 * @generated
	 */
	EAttribute getDecoratorProvider_ModelValueKind();
	...
	/**
	 * Returns the meta object for class '
	 * {@link com.rcpcompany.uibindings.IAssignmentParticipantsManager
	 * <em>Assignment Participants Manager</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for class '<em>Assignment Participants Manager</em>'.
	 * @see com.rcpcompany.uibindings.IAssignmentParticipantsManager
	 * @generated
	 */
	EClass getAssignmentParticipantsManager();

	/**
	 * Returns the meta object for the reference list '
	 * {@link com.rcpcompany.uibindings.IAssignmentParticipantsManager#getParticipants
	 ...
	 * @see #getAssignmentParticipantsManager()
	 * @generated
	 */
	EReference getAssignmentParticipantsManager_Participants();

	/**
	 * Returns the meta object for class '
	 * {@link com.rcpcompany.uibindings.IAssignmentParticipantDescriptor
	 * <em>Assignment Participant Descriptor</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for class '<em>Assignment Participant Descriptor</em>'.
	 * @see com.rcpcompany.uibindings.IAssignmentParticipantDescriptor
	 * @generated
	 */
	EClass getAssignmentParticipantDescriptor();
	 ...
	 * @generated
	 */
	EReference getAssignmentParticipantDescriptor_Manager();
	 ...
	 * 
	 * @return the meta object for the attribute '<em>Id</em>'.
	 * @see com.rcpcompany.uibindings.IAssignmentParticipantDescriptor#getId()
	 * @see #getAssignmentParticipantDescriptor()
	 * @generated
	 */
	EAttribute getAssignmentParticipantDescriptor_Id();

	/**
	 * Returns the meta object for the attribute list '
	 * {@link com.rcpcompany.uibindings.IAssignmentParticipantDescriptor#getSourceTypes
	 * <em>Source Types</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute list '<em>Source Types</em>'.
	 * @see com.rcpcompany.uibindings.IAssignmentParticipantDescriptor#getSourceTypes()
	 * @see #getAssignmentParticipantDescriptor()
	 * @generated
	 */
	EAttribute getAssignmentParticipantDescriptor_SourceTypes();

	/**
	 * Returns the meta object for the attribute list '
	 * {@link com.rcpcompany.uibindings.IAssignmentParticipantDescriptor#getDestinationTypes
	 * <em>Destination Types</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute list '<em>Destination Types</em>'.
	 * @see com.rcpcompany.uibindings.IAssignmentParticipantDescriptor#getDestinationTypes()
	 * @see #getAssignmentParticipantDescriptor()
	 * @generated
	 */
	EAttribute getAssignmentParticipantDescriptor_DestinationTypes();
	 ...
	 * @see com.rcpcompany.uibindings.IAssignmentParticipantDescriptor#getParticipant()
	 * @see #getAssignmentParticipantDescriptor()
	 * @generated
	 */
	EAttribute getAssignmentParticipantDescriptor_Participant();
	...
	/**
	 * Returns the meta object for class '{@link java.util.Map.Entry
	 * <em>String To Argument Information Map Entry</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @return the meta object for class '<em>String To Argument Information Map Entry</em>'.
	 * @see java.util.Map.Entry
	 * @generated
	 */
	EClass getStringToArgumentInformationMapEntry();
	 ...
	 * @return the meta object for the attribute '<em>Key</em>'.
	 * @see java.util.Map.Entry
	 * @see #getStringToArgumentInformationMapEntry()
	 * @generated
	 */
	EAttribute getStringToArgumentInformationMapEntry_Key();
	 ...
	 * @generated
	 */
	EReference getStringToArgumentInformationMapEntry_Value();
	...
	/**
	 * Returns the meta object for enum '{@link com.rcpcompany.uibindings.ModelValueKind
	 * <em>Model Value Kind</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for enum '<em>Model Value Kind</em>'.
	 * @see com.rcpcompany.uibindings.ModelValueKind
	 * @generated
	 */
	EEnum getModelValueKind();
	...
	/**
	 * Returns the meta object for enum '{@link com.rcpcompany.uibindings.ContainerCellType
	 * <em>Container Cell Type</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for enum '<em>Container Cell Type</em>'.
	 * @see com.rcpcompany.uibindings.ContainerCellType
	 * @generated
	 */
	EEnum getContainerCellType();
	...
	/**
	 * Returns the meta object for data type '
	 * {@link com.rcpcompany.uibindings.participants.IAssignmentParticipant
	 * <em>IAssignment Participant</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for data type '<em>IAssignment Participant</em>'.
	 * @see com.rcpcompany.uibindings.participants.IAssignmentParticipant
	 * @generated
	 */
	EDataType getIAssignmentParticipant();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Assignment Particiants Manager</b></em>'
		 * reference feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EReference MANAGER__ASSIGNMENT_PARTICIANTS_MANAGER = eINSTANCE.getManager_AssignmentParticiantsManager();
		...
		/**
		 * The meta object literal for the '<em><b>Argument Information</b></em>' map feature. <!--
		 * begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EReference MANAGER__ARGUMENT_INFORMATION = eINSTANCE.getManager_ArgumentInformation();
		...
		/**
		 * The meta object literal for the '<em><b>Model Kind</b></em>' attribute feature. <!--
		 * begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute VALUE_BINDING__MODEL_KIND = eINSTANCE.getValueBinding_ModelKind();
		...
		/**
		 * The meta object literal for the '<em><b>Model Observable List</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute VALUE_BINDING__MODEL_OBSERVABLE_LIST = eINSTANCE.getValueBinding_ModelObservableList();
		 ...
		 * @generated
		 */
		EClass ARGUMENT_INFORMATION = eINSTANCE.getArgumentInformation();
		 ...
		 * @generated
		 */
		EAttribute ARGUMENT_INFORMATION__NAME = eINSTANCE.getArgumentInformation_Name();

		/**
		 * The meta object literal for the '<em><b>Lookup Parent</b></em>' attribute feature. <!--
		 * begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute ARGUMENT_INFORMATION__LOOKUP_PARENT = eINSTANCE.getArgumentInformation_LookupParent();

		/**
		 * The meta object literal for the '<em><b>Lookup Attribute Target Type</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute ARGUMENT_INFORMATION__LOOKUP_ATTRIBUTE_TARGET_TYPE = eINSTANCE
				.getArgumentInformation_LookupAttributeTargetType();

		/**
		 * The meta object literal for the '<em><b>Lookup Attribute Containing Class</b></em>'
		 * attribute feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute ARGUMENT_INFORMATION__LOOKUP_ATTRIBUTE_CONTAINING_CLASS = eINSTANCE
				.getArgumentInformation_LookupAttributeContainingClass();

		/**
		 * The meta object literal for the '<em><b>Lookup Reference Target Type</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute ARGUMENT_INFORMATION__LOOKUP_REFERENCE_TARGET_TYPE = eINSTANCE
				.getArgumentInformation_LookupReferenceTargetType();

		/**
		 * The meta object literal for the '<em><b>Lookup Reference Containing Class</b></em>'
		 * attribute feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute ARGUMENT_INFORMATION__LOOKUP_REFERENCE_CONTAINING_CLASS = eINSTANCE
		...
		/**
		 * The meta object literal for the '<em><b>Model Value Kind</b></em>' attribute feature.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute DECORATOR_PROVIDER__MODEL_VALUE_KIND = eINSTANCE.getDecoratorProvider_ModelValueKind();
		 ...
		 * The meta object literal for the '
		 * {@link com.rcpcompany.uibindings.internal.AssignmentParticipantsManagerImpl
		 * <em>Assignment Participants Manager</em>}' class. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @see com.rcpcompany.uibindings.internal.AssignmentParticipantsManagerImpl
		 * @see com.rcpcompany.uibindings.internal.UIBindingsPackageImpl#getAssignmentParticipantsManager()
		 * @generated
		 */
		EClass ASSIGNMENT_PARTICIPANTS_MANAGER = eINSTANCE.getAssignmentParticipantsManager();
		 ...
		 * @generated
		 */
		EReference ASSIGNMENT_PARTICIPANTS_MANAGER__PARTICIPANTS = eINSTANCE
				.getAssignmentParticipantsManager_Participants();

		/**
		 * The meta object literal for the '
		 * {@link com.rcpcompany.uibindings.internal.AssignmentParticipantDescriptorImpl
		 * <em>Assignment Participant Descriptor</em>}' class. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @see com.rcpcompany.uibindings.internal.AssignmentParticipantDescriptorImpl
		 * @see com.rcpcompany.uibindings.internal.UIBindingsPackageImpl#getAssignmentParticipantDescriptor()
		 * @generated
		 */
		EClass ASSIGNMENT_PARTICIPANT_DESCRIPTOR = eINSTANCE.getAssignmentParticipantDescriptor();
		 ...
		 * @generated
		 */
		EReference ASSIGNMENT_PARTICIPANT_DESCRIPTOR__MANAGER = eINSTANCE.getAssignmentParticipantDescriptor_Manager();
		 ...
		 * @generated
		 */
		EAttribute ASSIGNMENT_PARTICIPANT_DESCRIPTOR__ID = eINSTANCE.getAssignmentParticipantDescriptor_Id();
		 ...
		 * @generated
		 */
		EAttribute ASSIGNMENT_PARTICIPANT_DESCRIPTOR__SOURCE_TYPES = eINSTANCE
				.getAssignmentParticipantDescriptor_SourceTypes();

		/**
		 * The meta object literal for the '<em><b>Destination Types</b></em>' attribute list
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute ASSIGNMENT_PARTICIPANT_DESCRIPTOR__DESTINATION_TYPES = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute ASSIGNMENT_PARTICIPANT_DESCRIPTOR__PARTICIPANT = eINSTANCE
		 ...
		 * @generated
		 */
		EClass STRING_TO_ARGUMENT_INFORMATION_MAP_ENTRY = eINSTANCE.getStringToArgumentInformationMapEntry();
		 ...
		 * @generated
		 */
		EAttribute STRING_TO_ARGUMENT_INFORMATION_MAP_ENTRY__KEY = eINSTANCE
		 ...
		 * @generated
		 */
		EReference STRING_TO_ARGUMENT_INFORMATION_MAP_ENTRY__VALUE = eINSTANCE
		...
		/**
		 * The meta object literal for the '{@link com.rcpcompany.uibindings.ModelValueKind
		 * <em>Model Value Kind</em>}' enum. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see com.rcpcompany.uibindings.ModelValueKind
		 * @see com.rcpcompany.uibindings.internal.UIBindingsPackageImpl#getModelValueKind()
		 * @generated
		 */
		EEnum MODEL_VALUE_KIND = eINSTANCE.getModelValueKind();
		...
		/**
		 * The meta object literal for the '{@link com.rcpcompany.uibindings.ContainerCellType
		 * <em>Container Cell Type</em>}' enum. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see com.rcpcompany.uibindings.ContainerCellType
		 * @see com.rcpcompany.uibindings.internal.UIBindingsPackageImpl#getContainerCellType()
		 * @generated
		 */
		EEnum CONTAINER_CELL_TYPE = eINSTANCE.getContainerCellType();
		...
		/**
		 * The meta object literal for the '<em>IAssignment Participant</em>' data type. <!--
		 * begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see com.rcpcompany.uibindings.participants.IAssignmentParticipant
		 * @see com.rcpcompany.uibindings.internal.UIBindingsPackageImpl#getIAssignmentParticipant()
		 * @generated
		 */
		EDataType IASSIGNMENT_PARTICIPANT = eINSTANCE.getIAssignmentParticipant();
