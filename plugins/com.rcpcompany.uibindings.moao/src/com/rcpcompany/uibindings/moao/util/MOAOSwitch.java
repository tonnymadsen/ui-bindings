...
public class MOAOSwitch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      case IMOAOPackage.MOAO: {
        IMOAO moao = (IMOAO)theEObject;
        T result = caseMOAO(moao);
        if (result == null) result = caseIAdaptable(moao);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case IMOAOPackage.NAMED_OBJECT: {
        INamedObject namedObject = (INamedObject)theEObject;
        T result = caseNamedObject(namedObject);
        if (result == null) result = caseMOAO(namedObject);
        if (result == null) result = caseIAdaptable(namedObject);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case IMOAOPackage.MOAO_MESSAGE: {
        IMOAOMessage moaoMessage = (IMOAOMessage)theEObject;
   ...
   * @generated
   */
  public T caseMOAOMessage(IMOAOMessage object) {
    return null;
  }
