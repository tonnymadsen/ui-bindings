...
public class MOAOAdapterFactory extends AdapterFactoryImpl {
   ...
   * @generated
   */
  protected MOAOSwitch<Adapter> modelSwitch =
    new MOAOSwitch<Adapter>() {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.rcpcompany.uibindings.moao.INamedObject <em>Named Object</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.rcpcompany.uibindings.moao.IMOAOMessage <em>Message</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
