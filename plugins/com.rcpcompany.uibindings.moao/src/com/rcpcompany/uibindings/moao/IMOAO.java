...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>MOAO</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface IMOAO extends EObject, IAdaptable {
   ...
   * The list contents are of type {@link com.rcpcompany.uibindings.moao.IMOAOMessage}.
   * It is bidirectional and its opposite is '{@link com.rcpcompany.uibindings.moao.IMOAOMessage#getObject <em>Object</em>}'.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Removes all messages from this object and all contained objects (using reflection) given by the specified owner.
   * @param owner the owner
   */
  void removeMessagesByOwner(String owner);

  /**
   * Checks that this object has a valid state and returns any result in the specified {@link DiagnosticChain}.
