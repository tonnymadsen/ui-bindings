 ...
 * <li>{@link com.rcpcompany.uibindings.navigator.IEditorModelType#getPreferredEditor <em>Preferred
 * Editor</em>}</li>
 * <li>{@link com.rcpcompany.uibindings.navigator.IEditorModelType#getModelType <em>Model Type</em>}
 * </li>
 * <li>{@link com.rcpcompany.uibindings.navigator.IEditorModelType#getModelTypeEClassifier <em>Model
 * Type EClassifier</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface IEditorModelType extends EObject {
	 ...
	 * type {@link com.rcpcompany.uibindings.navigator.IEditorPartDescriptor}. It is bidirectional
	 * and its opposite is '
	 * {@link com.rcpcompany.uibindings.navigator.IEditorPartDescriptor#getModelType
	 * <em>Model Type</em>}'. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Model Type EClassifier</em>' reference isn't clear, there really
	...
	/**
	 * Sets the value of the '
	 * {@link com.rcpcompany.uibindings.navigator.IEditorModelType#getModelTypeEClassifier
	 * <em>Model Type EClassifier</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
