 ...
 * Model Type</em>}</li>
 * <li>{@link com.rcpcompany.uibindings.navigator.internal.EditorModelTypeImpl#isAutoGenerated <em>
 * Auto Generated</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class EditorModelTypeImpl extends EObjectImpl implements IEditorModelType {
	...
	public void setAutoGenerated(boolean newAutoGenerated) {
		final boolean oldAutoGenerated = autoGenerated;
		autoGenerated = newAutoGenerated;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					INavigatorModelPackage.EDITOR_MODEL_TYPE__AUTO_GENERATED, oldAutoGenerated, autoGenerated));
	}
