 ...
 *   <li>{@link com.rcpcompany.uibindings.navigator.internal.EditorModelTypeImpl#isAutoGenerated <em>Auto Generated</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EditorModelTypeImpl extends EObjectImpl implements IEditorModelType {
	...
	public void setAutoGenerated(boolean newAutoGenerated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, INavigatorModelPackage.EDITOR_MODEL_TYPE__AUTO_GENERATED, oldAutoGenerated, autoGenerated));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case INavigatorModelPackage.EDITOR_MODEL_TYPE__MODEL_TYPE:
				return getModelType();
			case INavigatorModelPackage.EDITOR_MODEL_TYPE__AUTO_GENERATED:
