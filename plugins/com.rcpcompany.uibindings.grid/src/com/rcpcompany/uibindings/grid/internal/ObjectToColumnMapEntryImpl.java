...
public class ObjectToColumnMapEntryImpl extends EObjectImpl implements
	 ...
	 * @ordered
	 */
	protected IGridBindingColumnInformation value;
	 ...
	 * @generated
	 */
	public ObjectToColumnMapEntryImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IGridPackage.Literals.OBJECT_TO_COLUMN_MAP_ENTRY;
	}
	...
	public void setTypedKey(Object newKey) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, IGridPackage.OBJECT_TO_COLUMN_MAP_ENTRY__KEY, oldKey,
					key));
		}
	}
	 ...
	 * @generated
	 */
	public IGridBindingColumnInformation getTypedValue() {
		return value;
	}
	 ...
	 * @generated
	 */
	public void setTypedValue(IGridBindingColumnInformation newValue) {
		final IGridBindingColumnInformation oldValue = value;
		value = newValue;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, IGridPackage.OBJECT_TO_COLUMN_MAP_ENTRY__VALUE,
					oldValue, value));
		}
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IGridPackage.OBJECT_TO_COLUMN_MAP_ENTRY__KEY:
			return getTypedKey();
		case IGridPackage.OBJECT_TO_COLUMN_MAP_ENTRY__VALUE:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case IGridPackage.OBJECT_TO_COLUMN_MAP_ENTRY__KEY:
			...
			return;
		case IGridPackage.OBJECT_TO_COLUMN_MAP_ENTRY__VALUE:
			setTypedValue((IGridBindingColumnInformation) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case IGridPackage.OBJECT_TO_COLUMN_MAP_ENTRY__KEY:
			...
			return;
		case IGridPackage.OBJECT_TO_COLUMN_MAP_ENTRY__VALUE:
			setTypedValue((IGridBindingColumnInformation) null);
			return;
		}
	...
	public EMap<Object, IGridBindingColumnInformation> getEMap() {
		final EObject container = eContainer();
		return container == null ? null : (EMap<Object, IGridBindingColumnInformation>) container
				.eGet(eContainmentFeature());
	}

} // ObjectToColumnMapEntryImpl
