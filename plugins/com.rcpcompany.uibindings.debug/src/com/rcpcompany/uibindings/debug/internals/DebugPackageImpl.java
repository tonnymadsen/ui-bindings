...
public class DebugPackageImpl extends EPackageImpl implements IDebugPackage {
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link IDebugPackage#eINSTANCE} when that field is accessed. Clients should not
	...
	public static IDebugPackage init() {
		if (isInited)
			return (IDebugPackage) EPackage.Registry.INSTANCE.getEPackage(IDebugPackage.eNS_URI);
