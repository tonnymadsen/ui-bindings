...
public class ScriptingSwitch<T> {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Feature Script</em>'. <!-- begin-user-doc
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>MOAO</em>'. <!-- begin-user-doc --> This
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Facet</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IDisposable</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
