...
public class ScriptEngineSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case IScriptEnginePackage.EOBJECT_TO_SCRIPT_DEPENDENCY_LIST_MAP_ENTRY: {
			@SuppressWarnings("unchecked")
			final Map.Entry<EObject, EList<IScriptDependency>> eObjectToScriptDependencyListMapEntry = (Map.Entry<EObject, EList<IScriptDependency>>) theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>EObject To Script Dependency List Map Entry</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '
	 *         <em>EObject To Script Dependency List Map Entry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
