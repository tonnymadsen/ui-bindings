...
public class ToOrStringTest {

	@Test
	public void testToStringObjectArray() {
		assertEquals("a, b or \"c d\"",
				ToStringUtils.toOrString(new Object[]{"a", "b", "c d"}));
		assertEquals("0, 0.1 or false",
				ToStringUtils.toOrString(new Object[]{0, 0.1f, false}));
	...
	public void testFormatHumanReadable() {
		...
		assertEquals("Current Row No",
				ToStringUtils.formatHumanReadable("currentRowNo"));
		...
		assertEquals("Is DNA Available",
				ToStringUtils.formatHumanReadable("isDNAAvailable"));
