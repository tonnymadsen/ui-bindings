...
public class ScriptingAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class ' {@link com.rcpcompany.uibindings.scripting.IFeatureScript
	 * <em>Feature Script</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.rcpcompany.uibindings.moao.IMOAO <em>MOAO</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class ' {@link com.rcpcompany.uibindings.moao.IMOAOFacet <em>Facet</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
