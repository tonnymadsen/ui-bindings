 ...
 * <ul>
 * <li>{@link com.rcpcompany.uibindings.tests.shop.internal.ShopItemDescriptionImpl#getDescription
...
public class ShopItemDescriptionImpl extends ShopItemInformationImpl implements ShopItemDescription {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShopPackage.SHOP_ITEM_DESCRIPTION__DESCRIPTION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ShopPackage.SHOP_ITEM_DESCRIPTION__DESCRIPTION:
