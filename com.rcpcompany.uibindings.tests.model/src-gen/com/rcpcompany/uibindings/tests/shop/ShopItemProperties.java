...
public interface ShopItemProperties extends INamedObject {
	 ...
	 * It is bidirectional and its opposite is '{@link com.rcpcompany.uibindings.tests.shop.ShopItem#getProperties <em>Properties</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Item</em>' container reference isn't clear, there really should be
	...
	/**
	 * Sets the value of the '{@link com.rcpcompany.uibindings.tests.shop.ShopItemProperties#getItem <em>Item</em>}' container reference.
	...
	/**
	 * Sets the value of the '{@link com.rcpcompany.uibindings.tests.shop.ShopItemProperties#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
